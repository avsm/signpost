...
/***
  ...
  License along with nss-signpost; If not, see
...
enum nss_status _nss_signpost_gethostbyname4_r(
                const char *name,
...
enum nss_status _nss_signpost_gethostbyname3_r(
                const char *name,
                int af,
                struct hostent *host,
                char *buffer, size_t buflen,
...
enum nss_status _nss_signpost_gethostbyaddr2_r(
...
enum nss_status _nss_signpost_gethostbyname2_r(
    ...
    return _nss_signpost_gethostbyname3_r(
            name,
            af,
            host,
            buffer, buflen,
...
enum nss_status _nss_signpost_gethostbyaddr_r(
    ...
    return _nss_signpost_gethostbyaddr2_r(
            addr, len,
            af,
            host,
            buffer, buflen,
